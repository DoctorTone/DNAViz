...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/controlKit.min.js":[function(require,module,exports) {
var define;
...
!function (e) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module) module.exports = e();else if ("function" == typeof define && define.amd) define([], e);else {
    var o;
    "undefined" != typeof window ? o = window : "undefined" != typeof global ? o = global : "undefined" != typeof self && (o = self), o.ControlKit = e();
  }
}(function () {
  ...
  return function e(t, n, r) {
    ...
    9: [function (require, module, exports) {
      ...
      function FunctionPlotter(parent, object, value, params) {
        ...
        this._center = [Math.round(size * .5), Math.round(size * .5)];
        this._svgPos = [0, 0];
        this._func = null;
      ...
      FunctionPlotter.prototype._sliderYStep = function (mousePos) {
        ...
        var handle = this._sliderYHandle,
            ...
            handleHeightHalf = handleHeight * .5;
    ...
    15: [function (require, module, exports) {
      ...
      NumberOutput.prototype._setValue = function () {
        ...
        if (_typeof(value) === "object" && typeof value.length === "number" && typeof value.splice === "function" && !value.propertyIsEnumerable("length")) {
          out = value.slice();
          var i = -1;
          var temp;
          var wrap = this._wrap;
    ...
    16: [function (require, module, exports) {
      ...
      Options.prototype = {
        _onDocumentMouseDown: function _onDocumentMouseDown() {
        ...
        build: function build(entries, selected, element, callbackSelect, callbackOut, paddingRight, areColors, colorMode) {
          ...
          var rootPosX = posX + width > windowWidth ? posX - width + elementWidth - strokeOffset : posX,
              rootPosY = posY + listHeight > windowHeight ? posY - listHeight * .5 - elementHeight * .5 : posY;
    ...
    18: [function (require, module, exports) {
      ...
      function Pad(parent, object, value, params) {
        ...
        handleCircle2.setAttribute("cy", String(.75));
      ...
      Pad.prototype._drawPoint = function () {
        var svgSize = Number(this._svg.getAttribute("width"));
        var value = this._obj[this._key];
        var localX = (.5 + value[0] * .5) * svgSize,
            localY = (.5 + -value[1] * .5) * svgSize;
        var pathCmd = "";
      ...
      Picker.prototype = {
        ...
        _updateHandleField: function _updateHandleField() {
          var width = this._canvasField.width,
              ...
              offsetHandle = this._handleFieldSize * .25;
          var satNorm = this._valueSat / this._valueSatMinMax[1],
              valNorm = this._valueVal / this._valueValMinMax[1];

          this._handleField.setPositionGlobal(satNorm * width - offsetHandle, (1 - valNorm) * height - offsetHandle);
        },
        ...
        _updateHandleSlider: function _updateHandleSlider() {
          var height = this._canvasSlider.height,
              offsetHandle = this._handleSliderHeight * .25;
        ...
        open: function open() {
          ...
          if (position[0] === null || position[1] === null) {
            position[0] = window.innerWidth * .5 - node.getWidth() * .5;
            position[1] = window.innerHeight * .5 - node.getHeight() * .5;
          } else {
    ...
    25: [function (require, module, exports) {
      ...
      function Slider(parent, object, value, range, params) {
        ...
        var slider = this._slider = new Slider_Internal(wrap, this._onSliderBegin.bind(this), this._onSliderMove.bind(this), this._onSliderEnd.bind(this));
    ...
    28: [function (require, module, exports) {
      ...
      StringOutput = function StringOutput(parent, object, value, params) {
        Output.apply(this, arguments);
      };
    ...
    29: [function (require, module, exports) {
      ...
      ValuePlotter.prototype._drawGrid = function () {
        ...
        var svgWidth = Number(svg.getAttribute("width")),
            svgHeightHalf = Math.floor(Number(svg.getAttribute("height")) * .5);
        var pathCmd = "";
      ...
      ValuePlotter.prototype._drawCurve = function () {
        ...
        var pathCmd = "";
        var heightHalf = Number(svg.getAttribute("height")) * .5,
            unit = heightHalf - this._lineWidth * .5;
        points[1] = buffer0[0];
    ...
    36: [function (require, module, exports) {
      ...
      ObjectComponentNotifier.prototype.onOptionTriggered = function (e) {
        this.dispatchEvent(new Event_(this, OptionEvent.TRIGGER, {
          origin: e.sender
        }));
      };
    ...
    38: [function (require, module, exports) {
      ...
      function createWindow() {
        var width = 320,
            height = 200;
        var window_ = window.open("", "", "        width=" + width + ",        height=" + height + ",        left=" + (window.screenX + window.innerWidth * .5 - width * .5) + ",        top=" + (window.screenY + window.innerHeight * .5 - height * .5) + ",        location=0,        titlebar=0,        resizable=0");
    ...
    41: [function (require, module, exports) {
      var ColorUtil = {
        HSV2RGB: function HSV2RGB(hue, sat, val) {
          var max_hue = 360,
              max_sat = 100,
              max_val = 100;
          var min_hue = 0,
    ...
    49: [function (require, module, exports) {
      ...
      EventDispatcher.prototype = {
        addEventListener: function addEventListener(eventType, listener, callbackMethod) {
    ...
    51: [function (require, module, exports) {
      ...
      function ScrollBar(parentNode, targetNode, wrapHeight) {
        ...
        this._onMouseWheel = function (e) {
          ...
          var scrollStep = self._scrollHeight * .0125;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/controlKit.min.js"], null)
//# sourceMappingURL=/controlKit.min.4df43c78.js.map